export const Black_Hole_Star_Discovery = {
  id: "Black_Hole_Star_Discovery",
  title: "First-Ever Black Hole Star Discovered by James Webb Space Telescope",
  summary:
  ...
  slug: "first-ever-black-hole-star-discovered-james-webb-space-telescope",
  metaDescription:
    "NASA's James Webb Space Telescope reveals a shocking new cosmic object — a black hole star radiating 100 billion times more energy than any star. Discovered 660 million years after the Big Bang, it could reshape our understanding of the universe.",
  canonicalUrl: "https://sciencenews.com/articles/Black_Hole_Star_Discovery",
  schemaType: "NewsArticle",
  content: {
    sections: [
      {
        title: "A Completely New Class of Cosmic Object",
        content:
      ...
      {
        title: "Location and Origin: 660 Million Years After the Big Bang",
        content:
      ...
      {
        title: "Dr. Rohan Naidu and the MIT Kavli Institute",
        content:
      ...
      {
        title: "Computer Modeling Confirms the Find: Object MoM-BH-1",
        content:
      ...
      {
        title: "Rethinking the Little Red Dots in Deep Space",
        content:
      ...
      {
        title: "Implications for Galaxy Evolution and the Universe History",
        content:
