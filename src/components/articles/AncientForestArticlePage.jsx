...
import { ancientForestArticle } from '../../data/articles/Ancient_Forest_Discovered_Under_Melting_Arctic_Ice.js';
import Header from '../Header.jsx';
import Footer from '../Footer.jsx';

const AncientForestArticlePage = () => {
  const navigate = useNavigate();
  const [visibleSections, setVisibleSections] = useState([0]); // First section is always visible
  
  const article = ancientForestArticle; // Direct import from the individual file
  ...
  const handleBackToHome = () => {
    // Navigate to the Environment category page
...
export default AncientForestArticlePage;
