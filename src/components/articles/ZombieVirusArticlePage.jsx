...
import zombieVirusArticle from '../../data/articles/Zombie_Virus_Rabbits';
import { Clock, User, Calendar, ArrowLeft, ChevronDown, ChevronUp } from 'lucide-react';
import { Button } from '@/components/ui/button.jsx';
import { Card, CardContent } from '@/components/ui/card.jsx';

const ZombieVirusArticlePage = () => {
  const navigate = useNavigate();
  const [visibleSections, setVisibleSections] = useState([0]); // First section is always visible
  const article = zombieVirusArticle;
        ...
        <article className="space-y-8">
          ...
          <div className="mt-6">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="bg-muted px-3 py-1 rounded-full text-sm">Wildlife Health</span>
              <span className="bg-muted px-3 py-1 rounded-full text-sm">Virology</span>
              <span className="bg-muted px-3 py-1 rounded-full text-sm">Papilloma Virus</span>
              <span className="bg-muted px-3 py-1 rounded-full text-sm">Public Health</span>
              <span className="bg-muted px-3 py-1 rounded-full text-sm">Colorado Wildlife</span>
            </div>
          </div>
        </article>
      </div>
...
export default ZombieVirusArticlePage;
