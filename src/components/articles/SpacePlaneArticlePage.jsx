...
import { Space_Plane_Mission } from '../../data/articles/Space_Plane_Mission';
import Header from '../Header.jsx';
import Footer from '../Footer.jsx';

const SpacePlaneArticlePage = () => {
  const navigate = useNavigate();
  const [visibleSections, setVisibleSections] = useState([0]); // First section is always visible
  
  const article = Space_Plane_Mission; // Direct import from the individual file
...
export default SpacePlaneArticlePage;
