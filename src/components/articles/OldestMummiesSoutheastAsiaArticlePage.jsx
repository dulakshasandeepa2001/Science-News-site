...
const OldestMummiesSoutheastAsiaArticlePage = () => {
  const navigate = useNavigate();
  const [visibleSections, setVisibleSections] = useState([0]); // First section is always visible
  
  const article = Oldest_Mummies_Southeast_Asia; // Direct import from the individual file
  ...
  const handleBackToHome = () => {
    // Navigate to the Archaeology category page
    navigate('/category/Archaeology');
...
export default OldestMummiesSoutheastAsiaArticlePage;