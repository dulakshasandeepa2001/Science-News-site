...
import { Humpback_Whales_Sound_Discovery } from '../../data/articles/Humpback_Whales_Sound_Discovery.js';
import Header from '../Header.jsx';
import Footer from '../Footer.jsx';

const HumpbackWhalesSoundDiscoveryArticlePage = () => {
  const navigate = useNavigate();
  const [visibleSections, setVisibleSections] = useState([0]); // First section is always visible
  
  const article = Humpback_Whales_Sound_Discovery; // Direct import from the individual file
  ...
  const handleBackToHome = () => {
    // Navigate to the Wildlife & Marine Biology category page
    navigate('/category/Wildlife-Marine-Biology');
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        >
          ...
          Back to Wildlife & Marine Biology Articles
        </Button>
...
export default HumpbackWhalesSoundDiscoveryArticlePage;