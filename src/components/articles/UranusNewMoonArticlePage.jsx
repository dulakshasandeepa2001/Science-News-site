...
import { Uranus_New_Moon_Discovery } from '../../data/articles/Uranus_New_Moon_Discovery';
import Header from '../Header.jsx';
import Footer from '../Footer.jsx';

const UranusNewMoonArticlePage = () => {
  const navigate = useNavigate();
  const [visibleSections, setVisibleSections] = useState([0]); // First section is always visible
  
  const article = Uranus_New_Moon_Discovery; // Direct import from the individual file
...
export default UranusNewMoonArticlePage;
