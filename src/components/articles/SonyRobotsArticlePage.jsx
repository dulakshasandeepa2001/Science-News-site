...
import { Sony_Humanoid_Robots_Weaknesses } from '../../data/articles/Sony_Humanoid_Robots_Weaknesses';
import Header from '../Header.jsx';
import Footer from '../Footer.jsx';

const SonyRobotsArticlePage = () => {
  const navigate = useNavigate();
  const [visibleSections, setVisibleSections] = useState([0]); // First section is always visible
  
  const article = Sony_Humanoid_Robots_Weaknesses; // Direct import from the individual file
...
export default SonyRobotsArticlePage;
