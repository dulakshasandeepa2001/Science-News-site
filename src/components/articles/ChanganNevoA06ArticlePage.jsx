...
import { Changan_Nevo_A06 } from '../../data/articles/Changan_Nevo_A06.js';
import Header from '../Header.jsx';
import Footer from '../Footer.jsx';

const ChanganNevoA06ArticlePage = () => {
  const navigate = useNavigate();
  const [visibleSections, setVisibleSections] = useState([0]); // First section is always visible
  
  const article = Changan_Nevo_A06; // Direct import from the individual file
...
export default ChanganNevoA06ArticlePage;
