...
import { Mars_Life_Discovery } from '../../data/articles/Mars_Life_Discovery.js';
import Header from '../Header.jsx';
import Footer from '../Footer.jsx';

const MarsLifeDiscoveryArticlePage = () => {
  const navigate = useNavigate();
  const [visibleSections, setVisibleSections] = useState([0]); // First section is always visible
  
  const article = Mars_Life_Discovery; // Direct import from the individual file
...
export default MarsLifeDiscoveryArticlePage;
