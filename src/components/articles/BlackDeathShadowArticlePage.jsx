...
import { Black_Death_Shadow } from '../../data/articles/Black_Death_Shadow';
import Header from '../Header.jsx';
import Footer from '../Footer.jsx';

const BlackDeathShadowArticlePage = () => {
  const navigate = useNavigate();
  const [visibleSections, setVisibleSections] = useState([0]); // First section is always visible
  
  const article = Black_Death_Shadow; // Direct import from the individual file
...
export default BlackDeathShadowArticlePage;
