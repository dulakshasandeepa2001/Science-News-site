...
import { Orange_Shark_Discovery } from '../../data/articles/Orange_Shark_Discovery';
import Header from '../Header.jsx';
import Footer from '../Footer.jsx';

const OrangeSharkArticlePage = () => {
  const navigate = useNavigate();
  const [visibleSections, setVisibleSections] = useState([0]); // First section is always visible
  
  const article = Orange_Shark_Discovery; // Direct import from the individual file
...
export default OrangeSharkArticlePage;
